...
- "성급한 일반화" (적은 사례로 모든 경우에 적용)
- "허위 이분법" (복잡한 문제를 단순히 둘 중 하나로만 나눔)
- "인신공격" (논리 대신 사람을 비난)
- "권위에 호소" (근거 없이 권위를 내세움)
- "감정적 편향" (이성보다 감정에 호소. 예: 충격, 분노)
- "과장된 표현" (사실보다 과도하게 부풀림. 예: 모든, 절대로)
- "허수아비 공격" (상대방 주장을 왜곡해서 공격)
- "순환논리" (증명할 것을 근거로 사용)
- "광고성 콘텐츠" (상품/서비스 홍보 의도)
- "긴급성 유도" (시간 압박. 예: 지금 당장, 마지막 기회)
- "과장된 수치" (근거 없거나 의심스러운 통계)
- "선동적 언어" (감정을 자극해 특정 의견 유도)
- "인과관계의 오류" (단순히 먼저 일어났다고 원인으로 단정)

## 🔥 생성 요구사항

1.  **카테고리 선택**: 위 목록에서 챌린지 주제(category)를 하나 선정합니다.

2.  **제목(질문) 생성**: "다음 중 '[선택한 카테고리]'이/가 있는 기사 문장을 선택하세요." 형식으로 title을 생성합니다.
...
4.  **정답(CorrectAnswers) 설정**: 정답 문장의 id를 배열에 담아 correctAnswers로 설정합니다. (예: ["2"])
...
### Beginner 예시
{
  ...
  "correctAnswers": ["3"],
  "explanation": "3번 문장은 '충격적인'이라는 단어를 사용하여 객관적인 사실 전달보다 독자의 감정을 먼저 자극하려 합니다. 이는 감정적 편향에 해당합니다. 1, 2, 4번 문장은 비교적 중립적으로 사실을 전달하고 있습니다.",
  "difficulty": "beginner",
  "points": 100,
  "hints": ["감정을 자극하는 수식어가 사용된 문장을 찾아보세요.", "사실 전달이 목적인 문장과 느낌 전달이 목적인 문장을 구분해보세요."]
}
    ...
    > = {
      beginner: {
        ...
        options: [
          ...
          { id: "2", text: "따라서 모든 사람이 A를 해야 합니다." }, // Answer
          { id: "3", text: "이는 절대적인 진리입니다." }, // 과장된 표현
          { id: "4", text: "이 연구는 매우 신뢰할 수 있습니다." },
        ],
        correctAnswers: ["2"],
        explanation:
          "2번 문장은 '한 연구 결과'만으로 '모든 사람'에게 적용하려 하므로 '성급한 일반화'의 오류입니다. 3번은 '과장된 표현'입니다.",
        hints: [
      ...
      intermediate: {
        ...
        hints: [
          "감정을 자극하는 표현들을 찾아보세요 (1번)",
          "구체적인 수치의 출처가 의심스럽지 않나요? (4번)",
          "'모든' 전문가라는 표현이 맞을까요? (2번)",
        ],
      },
      advanced: {
